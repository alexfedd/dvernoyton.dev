  ...
  <section class="dealers-banner">
    <div class="container dealers-banner__container">
      <div class="dealers-banner__left">
        ...
        <p class="dealers-banner__text">
          Данной страницы не существует. Просим вас вернуться на главную страницу.
        </p>
        <a href="/" class="dealers-banner__button solid-button"
          >На главную</a
        >
      </div>
