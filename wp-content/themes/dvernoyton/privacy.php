<?
// Template Name: Страница Политики конфиденциальности
...
?>
    <main class="main container">
      <div class=" privacy">
        <h2 class="title-h2">Политика конфиденциальности</h2>
        <p class="privacy__text">
          ...
          предпринимаемые ООО «Дверной Тон» (далее — Оператор).
          <br /><br />
          ...
          сети интернет по сетевому адресу https://dvernoyton.com.
          <br /><br />
          ...
          обезличивание персональных данных Отправка информационных писем на
          ...
          info@dvernoyton.com с пометкой «Актуализация персональных данных».
          <br /><br />
          ...
          на электронный адрес Оператора info@dvernoyton.com с пометкой «Отзыв
          ...
          Оператору с помощью электронной почты info@dvernoyton.com.
          <br /><br />
          ...
          сети Интернет по адресу https://dvernoyton.com/privacy.
        </p>
      </div>
    </main>
    <? get_footer() ?>
