        ...
        <div class="container doors-info__container">
          ...
          <div class="doors-info__right">
            <p class="doors-info__text">
              Компания Дверной Тон — крупнейший поставщик специализированных
              дверей на территории России. Мы являемся официальным дилером
              ведущих производителей, что позволяет нам предлагать широкий
              ассортимент дверей различных типов и назначения, а также выгодные
