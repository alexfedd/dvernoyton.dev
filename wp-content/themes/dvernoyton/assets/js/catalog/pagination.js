document.addEventListener("DOMContentLoaded", function () {
  ...
  function collectFilters() {
    ...
    document
      .querySelectorAll(".catalog__filters .catalog__filter")
  ...
  filterButton.addEventListener("click", function (e) {
    ...
    document
      .querySelector(".catalog__filters-list")
      .classList.toggle("catalog__filters--opened");
  ...
  function handleScroll() {
    const container = document.querySelector(".catalog__items");
    if (
      window.innerHeight + window.scrollY >= container.offsetHeight - 500 &&
